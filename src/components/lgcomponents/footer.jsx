  ...
  return (
    <div className="lg:mt-16 mt-7">
      <div className="flex flex-col items-center gap-5 border border-black">
        {/** first section */}
        <div className="border border-red-500 flex items-center flex-col gap-3">
        ...
        {/** second section */}
        <div className="bg-neutral-Black text-neutral-white flex w-full">
          {/** first division */}
          <div>
            <div>
            ...
            <div className="flex gap-3">
              <span className=" bg-neutral-Gray rounded-full p-1 flex justify-center items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={30}
                  height={30}
          ...
          <div className="flex">
            ...
            <div>
              ...
              <div>
                ...
                <img
                  className="size-5"
                  src="./assets/logImage/paper-plane-outline.svg"
                />
              </div>
            </div>
          </div>
